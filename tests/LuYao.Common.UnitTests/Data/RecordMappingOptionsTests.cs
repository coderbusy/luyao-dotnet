...
public class RecordMappingOptionsTests
{
    ...
    private class DtoWithDecimal
    {
        public decimal Price { get; set; }
    }

    [TestMethod]
    public void CustomConverter_UsedWhen_BuiltinCannotHandle()
    {
        // decimal 不是 RecordTable 内置支持的类型，用自定义转换器处理
        var table = new RecordTable();
        table.Columns.Add<string>("Price");
        var row = table.AddRow();
    ...
    [TestMethod]
    public void Options_AddConverter_Throws_AfterMapping()
    {
        var options = new RecordMappingOptions();
